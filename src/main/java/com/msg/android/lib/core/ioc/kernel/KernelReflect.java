package com.msg.android.lib.core.ioc.kernel;

import com.msg.android.lib.core.ioc.kernel.KernelLang.BreakException;
import com.msg.android.lib.core.ioc.kernel.KernelLang.CallbackBreak;
	...
	public static Method assignableMethod(Class cls, final String name, int ancest, boolean declared, boolean assignable, boolean cacheable, final Class... parameterTypes) {
		...
		while (cls != null) {
			if (assignable && parameterTypes.length > 0) {
				...
				KernelLang.CallbackBreak<Method> callback = new CallbackBreak<Method>() {
