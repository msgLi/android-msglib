package com.msg.android.lib.widget.utils;
...
public class WidgetUtils {
    ...
    public static void setColor(Activity activity, int color, int statusBarAlpha) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (count > 0 && decorView.getChildAt(count - 1) instanceof StatusBarView) {
                decorView.getChildAt(count - 1).setVisibility(View.VISIBLE);
    ...
    public static void setTranslucentColor(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            int count = decorView.getChildCount();
            if (count > 0 && decorView.getChildAt(count - 1) instanceof StatusBarView) {
                decorView.getChildAt(count - 1).setVisibility(View.GONE);
                decorView.getChildAt(count - 1).setBackgroundColor(activity.getResources().getColor(android.R.color.transparent));
            }
        }
    }
    ...
    public static void setStatusBarTransport(Activity context){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
